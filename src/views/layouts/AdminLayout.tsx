        ...
        <ul className="side-nav">
          <li
            className={`side-nav__item ${
              active === "dashboard" ? "side-nav__item--active" : ""
            }`}
          ...
          <li
            className={`side-nav__item ${
              active === "agence" ? "side-nav__item--active" : ""
            }`}
            onClick={() => updateActive("agence")}
          >
          ...
          <li
            className={`side-nav__item ${
              active === "users" ? "side-nav__item--active" : ""
            }`}
          ...
          <li
            className={`side-nav__item ${
              active === "offers" ? "side-nav__item--active" : ""
            }`}
            onClick={() => updateActive("offers")}
          >
